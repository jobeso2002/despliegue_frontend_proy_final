      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md border-l-4 border-green-500">
            ...
            <p className="text-3xl font-bold text-green-600 mb-4">1</p>
            <button className="text-green-500 hover:text-green-700 font-medium">
              <Link to="/dashboard/partidos">Ver partidos</Link>
            </button>
          </div>
        </div>
      </div>
